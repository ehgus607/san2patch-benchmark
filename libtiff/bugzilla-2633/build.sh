...
# PROJECT_CFLAGS="-static -fsanitize=undefined  -ggdb ${OPT}"
# PROJECT_CPPFLAGS="-static -fsanitize=undefined  -ggdb ${OPT}"
# PROJECT_LDFLAGS="-static  -fsanitize=undefined  ${OPT}"

PROJECT_CFLAGS="-static  -ggdb ${OPT}"
PROJECT_CPPFLAGS="-static  -ggdb ${OPT}"
